// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      { first: 'Katherine', last: 'Blodgett', year: 1898, passed: 1979 },
       { first: 'bada', last: 'Lovelace', year: 1815, passed: 1852 },
    ...
    const byLastName = inventors.sort(function(a, b){
    ...
    const sortByLived = inventors.sort(function(a, b) 
    {
   ...
   /* const category = document.querySelector('.mw-category');
    ...
    const vehicleCount =  data .reduce(function(obj, item){
